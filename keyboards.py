...
pet_type = ['Котёнок', 'Щенок', 'Кот', 'Собака']
...
kb_help_menu = InlineKeyboardMarkup(
    inline_keyboard=[[InlineKeyboardButton(text='🏠Передержка', callback_data='help|keep'),
                      InlineKeyboardButton(text='🚗Автопомощь', callback_data='help|auto')],
